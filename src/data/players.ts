...
function makePlayer(team: string, p: PlayerInput): Player {
  return {
    ...
    ...(p.depthChg ? { depthChange: p.depthChg } : {}),
    stats: p.stats,
  };
}
...
function generateNonShowcaseTeams(): Player[] {
  ...
  const teamData: [string, PlayerInput[]][] = [
    // === BALTIMORE RAVENS ===
    ["BAL", [
      { pos: "QB", pg: o, d: 1, name: "Lamar Jackson", num: 8, h: "6-2", w: "212", age: 27, col: "Louisville", exp: 7, espnId: "3916387", stats: { passYds: 3678, passTD: 24, int: 7, qbr: 96.4 } },
      { pos: "QB", pg: o, d: 2, name: "Tyler Huntley", num: 2, h: "6-1", w: "196", age: 26, col: "Utah", exp: 4, stats: { passYds: 0, passTD: 0, int: 0, qbr: 0 } },
      { pos: "RB", pg: o, d: 1, name: "Derrick Henry", num: 22, h: "6-3", w: "247", age: 30, col: "Alabama", exp: 9, espnId: "3043078", stats: { rushYds: 1450, rushTD: 13, ypc: 5.0, rec: 20 } },
      ...
      { pos: "WR1", pg: o, d: 1, name: "Zay Flowers", num: 4, h: "5-9", w: "182", age: 24, col: "Boston College", exp: 2, espnId: "4429615", stats: { recYds: 858, recTD: 5, rec: 68, targets: 100 } },
      ...
      { pos: "TE", pg: o, d: 1, name: "Mark Andrews", num: 89, h: "6-5", w: "256", age: 29, col: "Oklahoma", exp: 7, espnId: "3116365", stats: { recYds: 700, recTD: 6, rec: 55, targets: 75 } },
      ...
      { pos: "PR", pg: st, d: 2, name: "Zay Flowers", num: 4, h: "5-9", w: "182", age: 24, col: "Boston College", exp: 2, espnId: "4429615", stats: { prYds: 20, prAvg: 5.0, prTD: 0, prLong: 10 } },
    ...
    // === CINCINNATI BENGALS ===
    ["CIN", [
      { pos: "QB", pg: o, d: 1, name: "Joe Burrow", num: 9, h: "6-4", w: "221", age: 28, col: "LSU", exp: 5, espnId: "3915511", stats: { passYds: 4475, passTD: 34, int: 9, qbr: 98.0 } },
      ...
      { pos: "WR1", pg: o, d: 1, name: "Ja'Marr Chase", num: 1, h: "6-0", w: "201", age: 24, col: "LSU", exp: 4, espnId: "4362628", stats: { recYds: 1380, recTD: 12, rec: 98, targets: 138 } },
      ...
      { pos: "WR2", pg: o, d: 1, name: "Tee Higgins", num: 5, h: "6-4", w: "219", age: 25, col: "Clemson", exp: 5, espnId: "4239993", stats: { recYds: 950, recTD: 7, rec: 60, targets: 90 } },
...
function createRemainingTeamRosters(): Player[] {
  ...
  function add(team: string, pos: string, depth: number, name: string, num: number, h: string, w: string, age: number, col: string, exp: number, stats: Record<string, number>, inj?: InjuryStatus, injD?: string, extra?: { injDate?: string; estReturn?: string; irDes?: "4-game" | "8-game" | "season"; practice?: "DNP" | "Limited" | "Full"; espnId?: string; depthChg?: "up" | "down" }) {
  ...
  add("PIT","WR1",1,"George Pickens",14,"6-3","200",23,"Georgia",3,{recYds:1050,recTD:8,rec:65,targets:105},undefined,undefined,{espnId:"4426354"});
  ...
  add("HOU","PR",1,"Tank Dell",3,"5-8","163",24,"Houston",2,{prYds:120,prAvg:9.0,prTD:0,prLong:22},undefined,undefined,{espnId:"4366031"});
  ...
  // Patch ESPN IDs onto generated players by name
  const espnIdMap: Record<string, string> = {
    "Lamar Jackson": "3916387", "Derrick Henry": "3043078", "Zay Flowers": "4429615",
    "Mark Andrews": "3116365", "Rashod Bateman": "4360939",
    "Joe Burrow": "3915511", "Ja'Marr Chase": "4362628", "Tee Higgins": "4239993",
    "Tua Tagovailoa": "4241479", "De'Von Achane": "4429160", "Jaylen Waddle": "4372016",
    "Tyreek Hill": "3116406", "Drake Maye": "4431452",
    "C.J. Stroud": "4432577", "Nico Collins": "4258173", "Tank Dell": "4366031",
    "Anthony Richardson": "4429084", "Jonathan Taylor": "4242335",
    "Trevor Lawrence": "4360310", "Tony Pollard": "3916148", "Calvin Ridley": "3925357",
    "Bo Nix": "4426338", "Courtland Sutton": "3128429",
    "Brock Bowers": "4432665", "Justin Herbert": "4038941", "Ladd McConkey": "4612826",
    "George Pickens": "4426354", "Malik Nabers": "4595348",
    "Jayden Daniels": "4426348", "Terry McLaurin": "3121422",
    "Justin Jefferson": "4262921", "Jordan Addison": "4429205",
    "Jordan Love": "4036378", "Josh Jacobs": "4047365", "Christian Watson": "4248528",
    "Jared Goff": "3046779", "Amon-Ra St. Brown": "4374302", "Jahmyr Gibbs": "4429795",
    "Sam LaPorta": "4430027", "Caleb Williams": "4431611", "Rome Odunze": "4431299",
    "D'Andre Swift": "4259545", "Cole Kmet": "4258595", "DJ Moore": "3915416",
    "Alvin Kamara": "3054850", "Chris Olave": "4361370",
    "Baker Mayfield": "3052587", "Mike Evans": "16737", "Chris Godwin": "3116165",
    "Bijan Robinson": "4430807", "Drake London": "4426502", "Kyle Pitts": "4360248",
    "Bryce Young": "4685720", "DK Metcalf": "4047650", "Jaxon Smith-Njigba": "4430878",
    "Kyler Murray": "3917315", "Marvin Harrison Jr.": "4432708",
    "Matthew Stafford": "12483", "Puka Nacua": "4426515", "Cooper Kupp": "2977187",
    "Josh Allen": "3918298", "Dalton Kincaid": "4385690", "James Cook": "4379399",
    "Khalil Shakir": "4373678",
    "Najee Harris": "4241457", "Pat Freiermuth": "4361411",
    "Saquon Barkley": "3929630", "A.J. Brown": "4047646", "DeVonta Smith": "4241478",
    "Dallas Goedert": "3121023", "Jalen Hurts": "4040715",
    "Dak Prescott": "2577417", "CeeDee Lamb": "4241389",
    "Nick Chubb": "3128720", "Amari Cooper": "2976316", "Myles Garrett": "3122132",
    "David Njoku": "3118267", "Deshaun Watson": "3122840",
  };
  for (const p of result) {
    if (!p.espnId && espnIdMap[p.name]) {
      p.espnId = espnIdMap[p.name];
    }
  }
...
export const players: Player[] = [
  ...
  // =============================================
  // --- Offense ---
  { id: pid("KC", "QB", 1), name: "Patrick Mahomes", team: "KC", position: "QB", positionGroup: "offense", depthOrder: 1, jerseyNumber: 15, height: "6-2", weight: "225", age: 29, college: "Texas Tech", experience: 8, injuryStatus: "Active", espnId: "3139477", stats: { passYds: 4183, passTD: 30, int: 11, qbr: 94.2 } },
  { id: pid("KC", "QB", 2), name: "Carson Wentz", team: "KC", position: "QB", positionGroup: "offense", depthOrder: 2, jerseyNumber: 11, height: "6-5", weight: "237", age: 32, college: "North Dakota State", experience: 9, injuryStatus: "Active", espnId: "2573079", stats: { passYds: 0, passTD: 0, int: 0, qbr: 0 } },
  { id: pid("KC", "QB", 3), name: "Chris Oladokun", team: "KC", position: "QB", positionGroup: "offense", depthOrder: 3, jerseyNumber: 6, height: "6-1", weight: "210", age: 27, college: "South Dakota State", experience: 3, injuryStatus: "Active", espnId: "4044111", stats: { passYds: 0, passTD: 0, int: 0, qbr: 0 } },
  { id: pid("KC", "RB", 1), name: "Isiah Pacheco", team: "KC", position: "RB", positionGroup: "offense", depthOrder: 1, jerseyNumber: 10, height: "5-10", weight: "215", age: 25, college: "Rutgers", experience: 3, injuryStatus: "Active", espnId: "4361529", stats: { rushYds: 1012, rushTD: 7, ypc: 4.5, rec: 32 } },
  { id: pid("KC", "RB", 2), name: "Clyde Edwards-Helaire", team: "KC", position: "RB", positionGroup: "offense", depthOrder: 2, jerseyNumber: 25, height: "5-7", weight: "207", age: 25, college: "LSU", experience: 5, injuryStatus: "Questionable", injuryDetail: "Knee — Limited practice Thu", practiceStatus: "Limited", espnId: "4361993", stats: { rushYds: 310, rushTD: 2, ypc: 3.8, rec: 18 } },
  ...
  { id: pid("KC", "WR1", 1), name: "Rashee Rice", team: "KC", position: "WR1", positionGroup: "offense", depthOrder: 1, jerseyNumber: 4, height: "6-1", weight: "200", age: 24, college: "SMU", experience: 2, injuryStatus: "Suspended", injuryDetail: "Suspended 6 games — off-field conduct", estimatedReturn: "Week 7", espnId: "4428331", stats: { recYds: 0, recTD: 0, rec: 0, targets: 0 } },
  { id: pid("KC", "WR1", 2), name: "Xavier Worthy", team: "KC", position: "WR1", positionGroup: "offense", depthOrder: 2, jerseyNumber: 1, height: "5-11", weight: "165", age: 21, college: "Texas", experience: 1, injuryStatus: "Active", depthChange: "up" as const, espnId: "4683062", stats: { recYds: 780, recTD: 6, rec: 52, targets: 75 } },
  { id: pid("KC", "WR1", 3), name: "Mecole Hardman", team: "KC", position: "WR1", positionGroup: "offense", depthOrder: 3, jerseyNumber: 12, height: "5-10", weight: "187", age: 26, college: "Georgia", experience: 6, injuryStatus: "Active", espnId: "4035004", stats: { recYds: 220, recTD: 2, rec: 18, targets: 28 } },
  { id: pid("KC", "WR2", 1), name: "Marquise Brown", team: "KC", position: "WR2", positionGroup: "offense", depthOrder: 1, jerseyNumber: 5, height: "5-9", weight: "170", age: 27, college: "Oklahoma", experience: 6, injuryStatus: "Active", espnId: "4360797", stats: { recYds: 650, recTD: 5, rec: 45, targets: 68 } },
  ...
  { id: pid("KC", "WR3", 1), name: "Skyy Moore", team: "KC", position: "WR3", positionGroup: "offense", depthOrder: 1, jerseyNumber: 24, height: "5-10", weight: "195", age: 24, college: "Western Michigan", experience: 3, injuryStatus: "Active", espnId: "4430191", stats: { recYds: 320, recTD: 2, rec: 25, targets: 38 } },
  { id: pid("KC", "WR3", 2), name: "Nikko Remigio", team: "KC", position: "WR3", positionGroup: "offense", depthOrder: 2, jerseyNumber: 84, height: "5-11", weight: "185", age: 25, college: "Fresno State", experience: 1, injuryStatus: "Active", espnId: "4372716", stats: { recYds: 45, recTD: 0, rec: 4, targets: 7 } },
  ...
  { id: pid("KC", "TE", 1), name: "Travis Kelce", team: "KC", position: "TE", positionGroup: "offense", depthOrder: 1, jerseyNumber: 87, height: "6-5", weight: "250", age: 35, college: "Cincinnati", experience: 12, injuryStatus: "Active", espnId: "15847", stats: { recYds: 823, recTD: 5, rec: 75, targets: 98 } },
  { id: pid("KC", "TE", 2), name: "Noah Gray", team: "KC", position: "TE", positionGroup: "offense", depthOrder: 2, jerseyNumber: 83, height: "6-3", weight: "240", age: 25, college: "Duke", experience: 4, injuryStatus: "Active", espnId: "4240472", stats: { recYds: 210, recTD: 2, rec: 22, targets: 30 } },
  { id: pid("KC", "TE", 3), name: "Jody Fortson", team: "KC", position: "TE", positionGroup: "offense", depthOrder: 3, jerseyNumber: 88, height: "6-4", weight: "230", age: 28, college: "Valdosta State", experience: 4, injuryStatus: "IR", injuryDetail: "Achilles — placed on IR Week 6", injuryDate: "2025-10-12", estimatedReturn: "Late December", irDesignation: "8-game", espnId: "4258173", stats: { recYds: 45, recTD: 1, rec: 5, targets: 8 } },
  ...
  { id: pid("KC", "LT", 2), name: "Wanya Morris", team: "KC", position: "LT", positionGroup: "offense", depthOrder: 2, jerseyNumber: 68, height: "6-5", weight: "310", age: 24, college: "Oklahoma", experience: 2, injuryStatus: "Active", espnId: "4570577", stats: { gamesStarted: 2, sacks: 0 } },
  ...
  { id: pid("KC", "C", 1), name: "Creed Humphrey", team: "KC", position: "C", positionGroup: "offense", depthOrder: 1, jerseyNumber: 52, height: "6-5", weight: "320", age: 25, college: "Oklahoma", experience: 4, injuryStatus: "Active", espnId: "4241385", stats: { gamesStarted: 17, sacks: 0 } },
  ...
  { id: pid("KC", "RG", 1), name: "Trey Smith", team: "KC", position: "RG", positionGroup: "offense", depthOrder: 1, jerseyNumber: 65, height: "6-6", weight: "320", age: 25, college: "Tennessee", experience: 4, injuryStatus: "Active", espnId: "4242459", stats: { gamesStarted: 17, sacks: 1 } },
  ...
  { id: pid("KC", "RT", 2), name: "Wanya Morris", team: "KC", position: "RT", positionGroup: "offense", depthOrder: 2, jerseyNumber: 68, height: "6-5", weight: "310", age: 24, college: "Oklahoma", experience: 2, injuryStatus: "Active", espnId: "4570577", stats: { gamesStarted: 3, sacks: 1 } },
  ...
  // --- Defense ---
  { id: pid("KC", "DE1", 1), name: "George Karlaftis", team: "KC", position: "DE1", positionGroup: "defense", depthOrder: 1, jerseyNumber: 56, height: "6-4", weight: "275", age: 24, college: "Purdue", experience: 3, injuryStatus: "Active", espnId: "4426376", stats: { tackles: 52, sacks: 8.5, tfl: 10, ff: 2 } },
  ...
  { id: pid("KC", "DT1", 1), name: "Chris Jones", team: "KC", position: "DT1", positionGroup: "defense", depthOrder: 1, jerseyNumber: 95, height: "6-6", weight: "310", age: 30, college: "Mississippi State", experience: 8, injuryStatus: "Active", espnId: "2976545", stats: { tackles: 48, sacks: 10.5, tfl: 12, ff: 3 } },
  ...
  { id: pid("KC", "LB1", 1), name: "Nick Bolton", team: "KC", position: "LB1", positionGroup: "defense", depthOrder: 1, jerseyNumber: 32, height: "6-0", weight: "237", age: 24, college: "Missouri", experience: 4, injuryStatus: "Active", espnId: "4362244", stats: { tackles: 120, sacks: 3.0, tfl: 8, int: 1 } },
  ...
  { id: pid("KC", "KR", 1), name: "Mecole Hardman", team: "KC", position: "KR", positionGroup: "specialTeams", depthOrder: 1, jerseyNumber: 12, height: "5-10", weight: "187", age: 26, college: "Georgia", experience: 6, injuryStatus: "Active", espnId: "4035004", stats: { krYds: 380, krAvg: 22.4, krTD: 0, krLong: 45 } },
  { id: pid("KC", "KR", 2), name: "Xavier Worthy", team: "KC", position: "KR", positionGroup: "specialTeams", depthOrder: 2, jerseyNumber: 1, height: "5-11", weight: "165", age: 21, college: "Texas", experience: 1, injuryStatus: "Active", espnId: "4683062", stats: { krYds: 120, krAvg: 20.0, krTD: 0, krLong: 30 } },
  { id: pid("KC", "KR", 3), name: "Nikko Remigio", team: "KC", position: "KR", positionGroup: "specialTeams", depthOrder: 3, jerseyNumber: 84, height: "5-11", weight: "185", age: 25, college: "Fresno State", experience: 1, injuryStatus: "Active", espnId: "4372716", stats: { krYds: 60, krAvg: 20.0, krTD: 0, krLong: 25 } },
  { id: pid("KC", "PR", 1), name: "Mecole Hardman", team: "KC", position: "PR", positionGroup: "specialTeams", depthOrder: 1, jerseyNumber: 12, height: "5-10", weight: "187", age: 26, college: "Georgia", experience: 6, injuryStatus: "Active", espnId: "4035004", stats: { prYds: 150, prAvg: 8.5, prTD: 0, prLong: 22 } },
  { id: pid("KC", "PR", 2), name: "Skyy Moore", team: "KC", position: "PR", positionGroup: "specialTeams", depthOrder: 2, jerseyNumber: 24, height: "5-10", weight: "195", age: 24, college: "Western Michigan", experience: 3, injuryStatus: "Active", espnId: "4430191", stats: { prYds: 40, prAvg: 6.7, prTD: 0, prLong: 15 } },
  { id: pid("KC", "PR", 3), name: "Nikko Remigio", team: "KC", position: "PR", positionGroup: "specialTeams", depthOrder: 3, jerseyNumber: 84, height: "5-11", weight: "185", age: 25, college: "Fresno State", experience: 1, injuryStatus: "Active", espnId: "4372716", stats: { prYds: 20, prAvg: 5.0, prTD: 0, prLong: 10 } },
  ...
  // =============================================
  // --- Offense ---
  { id: pid("PHI", "QB", 1), name: "Jalen Hurts", team: "PHI", position: "QB", positionGroup: "offense", depthOrder: 1, jerseyNumber: 1, height: "6-1", weight: "223", age: 26, college: "Oklahoma", experience: 5, injuryStatus: "Questionable", injuryDetail: "Ankle — tweaked in practice", practiceStatus: "Limited", espnId: "4040715", stats: { passYds: 3858, passTD: 28, int: 12, qbr: 91.5 } },
  ...
  { id: pid("PHI", "RB", 1), name: "Saquon Barkley", team: "PHI", position: "RB", positionGroup: "offense", depthOrder: 1, jerseyNumber: 26, height: "6-0", weight: "232", age: 27, college: "Penn State", experience: 7, injuryStatus: "Active", espnId: "3929630", stats: { rushYds: 1312, rushTD: 11, ypc: 5.1, rec: 38 } },
  ...
  { id: pid("PHI", "WR1", 1), name: "A.J. Brown", team: "PHI", position: "WR1", positionGroup: "offense", depthOrder: 1, jerseyNumber: 11, height: "6-1", weight: "226", age: 27, college: "Ole Miss", experience: 6, injuryStatus: "Active", espnId: "4047646", stats: { recYds: 1230, recTD: 9, rec: 78, targets: 120 } },
  ...
  { id: pid("PHI", "WR2", 1), name: "DeVonta Smith", team: "PHI", position: "WR2", positionGroup: "offense", depthOrder: 1, jerseyNumber: 6, height: "6-0", weight: "170", age: 26, college: "Alabama", experience: 4, injuryStatus: "Active", espnId: "4241478", stats: { recYds: 1050, recTD: 7, rec: 72, targets: 110 } },
  ...
  { id: pid("PHI", "TE", 1), name: "Dallas Goedert", team: "PHI", position: "TE", positionGroup: "offense", depthOrder: 1, jerseyNumber: 88, height: "6-5", weight: "256", age: 29, college: "South Dakota State", experience: 7, injuryStatus: "Active", espnId: "3121023", stats: { recYds: 650, recTD: 4, rec: 55, targets: 72 } },
  ...
  { id: pid("PHI", "LT", 1), name: "Jordan Mailata", team: "PHI", position: "LT", positionGroup: "offense", depthOrder: 1, jerseyNumber: 68, height: "6-8", weight: "365", age: 27, college: "None (Australia)", experience: 7, injuryStatus: "Active", espnId: "4334215", stats: { gamesStarted: 16, sacks: 2 } },
  ...
  { id: pid("PHI", "LG", 1), name: "Landon Dickerson", team: "PHI", position: "LG", positionGroup: "offense", depthOrder: 1, jerseyNumber: 69, height: "6-6", weight: "333", age: 26, college: "Alabama", experience: 4, injuryStatus: "Active", espnId: "4035624", stats: { gamesStarted: 17, sacks: 1 } },
  ...
  { id: pid("PHI", "RT", 1), name: "Lane Johnson", team: "PHI", position: "RT", positionGroup: "offense", depthOrder: 1, jerseyNumber: 65, height: "6-6", weight: "317", age: 34, college: "Oklahoma", experience: 12, injuryStatus: "Active", espnId: "15797", stats: { gamesStarted: 16, sacks: 2 } },
  ...
  { id: pid("PHI", "PR", 3), name: "DeVonta Smith", team: "PHI", position: "PR", positionGroup: "specialTeams", depthOrder: 3, jerseyNumber: 6, height: "6-0", weight: "170", age: 26, college: "Alabama", experience: 4, injuryStatus: "Active", espnId: "4241478", stats: { prYds: 0, prAvg: 0, prTD: 0, prLong: 0 } },
  ...
  // =============================================
  // --- Offense ---
  { id: pid("DAL", "QB", 1), name: "Dak Prescott", team: "DAL", position: "QB", positionGroup: "offense", depthOrder: 1, jerseyNumber: 4, height: "6-2", weight: "238", age: 31, college: "Mississippi State", experience: 9, injuryStatus: "Out", injuryDetail: "Hamstring — ruled out", injuryDate: "2025-11-10", estimatedReturn: "Week 12", practiceStatus: "DNP", espnId: "2577417", stats: { passYds: 3200, passTD: 22, int: 10, qbr: 88.5 } },
  ...
  { id: pid("DAL", "RB", 1), name: "Ezekiel Elliott", team: "DAL", position: "RB", positionGroup: "offense", depthOrder: 1, jerseyNumber: 21, height: "6-0", weight: "228", age: 29, college: "Ohio State", experience: 9, injuryStatus: "Active", espnId: "3051392", stats: { rushYds: 640, rushTD: 5, ypc: 3.8, rec: 20 } },
  ...
  { id: pid("DAL", "WR1", 1), name: "CeeDee Lamb", team: "DAL", position: "WR1", positionGroup: "offense", depthOrder: 1, jerseyNumber: 88, height: "6-2", weight: "198", age: 25, college: "Oklahoma", experience: 5, injuryStatus: "Active", espnId: "4241389", stats: { recYds: 1350, recTD: 10, rec: 105, targets: 150 } },
  ...
  { id: pid("DAL", "TE", 1), name: "Jake Ferguson", team: "DAL", position: "TE", positionGroup: "offense", depthOrder: 1, jerseyNumber: 48, height: "6-5", weight: "250", age: 25, college: "Wisconsin", experience: 3, injuryStatus: "Active", espnId: "4242355", stats: { recYds: 580, recTD: 5, rec: 52, targets: 68 } },
  ...
  { id: pid("DAL", "LG", 1), name: "Tyler Smith", team: "DAL", position: "LG", positionGroup: "offense", depthOrder: 1, jerseyNumber: 73, height: "6-5", weight: "324", age: 23, college: "Tulsa", experience: 3, injuryStatus: "Active", espnId: "4568652", stats: { gamesStarted: 16, sacks: 2 } },
  ...
  { id: pid("DAL", "RG", 1), name: "Zack Martin", team: "DAL", position: "RG", positionGroup: "offense", depthOrder: 1, jerseyNumber: 70, height: "6-4", weight: "315", age: 34, college: "Notre Dame", experience: 11, injuryStatus: "Active", espnId: "16734", stats: { gamesStarted: 15, sacks: 0 } },
  ...
  // --- Defense ---
  { id: pid("DAL", "DE1", 1), name: "Micah Parsons", team: "DAL", position: "DE1", positionGroup: "defense", depthOrder: 1, jerseyNumber: 11, height: "6-3", weight: "245", age: 25, college: "Penn State", experience: 4, injuryStatus: "Active", espnId: "4567048", stats: { tackles: 65, sacks: 14.0, tfl: 18, ff: 3 } },
  ...
  { id: pid("DAL", "DE2", 1), name: "DeMarcus Lawrence", team: "DAL", position: "DE2", positionGroup: "defense", depthOrder: 1, jerseyNumber: 90, height: "6-3", weight: "254", age: 32, college: "Boise State", experience: 11, injuryStatus: "Doubtful", injuryDetail: "Foot — did not practice all week", practiceStatus: "DNP", espnId: "2976212", stats: { tackles: 30, sacks: 5.0, tfl: 7, ff: 2 } },
  ...
  { id: pid("DAL", "CB1", 1), name: "Trevon Diggs", team: "DAL", position: "CB1", positionGroup: "defense", depthOrder: 1, jerseyNumber: 7, height: "6-1", weight: "195", age: 26, college: "Alabama", experience: 5, injuryStatus: "Active", espnId: "3915416", stats: { tackles: 40, int: 4, pd: 12, ff: 0 } },
  ...
  // =============================================
  // --- Offense ---
  { id: pid("SF", "QB", 1), name: "Brock Purdy", team: "SF", position: "QB", positionGroup: "offense", depthOrder: 1, jerseyNumber: 13, height: "6-1", weight: "220", age: 24, college: "Iowa State", experience: 3, injuryStatus: "Active", espnId: "4361741", stats: { passYds: 4280, passTD: 31, int: 11, qbr: 97.5 } },
  ...
  { id: pid("SF", "RB", 1), name: "Christian McCaffrey", team: "SF", position: "RB", positionGroup: "offense", depthOrder: 1, jerseyNumber: 23, height: "5-11", weight: "205", age: 28, college: "Stanford", experience: 8, injuryStatus: "IR", injuryDetail: "Knee — placed on IR", injuryDate: "2025-09-15", estimatedReturn: "Week 10", irDesignation: "8-game", practiceStatus: "Limited", espnId: "3117251", stats: { rushYds: 280, rushTD: 2, ypc: 4.8, rec: 15 } },
  { id: pid("SF", "RB", 2), name: "Jordan Mason", team: "SF", position: "RB", positionGroup: "offense", depthOrder: 2, jerseyNumber: 24, height: "5-11", weight: "203", age: 25, college: "Georgia Tech", experience: 3, injuryStatus: "Active", depthChange: "up" as const, espnId: "4360569", stats: { rushYds: 820, rushTD: 6, ypc: 5.2, rec: 18 } },
  ...
  { id: pid("SF", "WR2", 1), name: "Brandon Aiyuk", team: "SF", position: "WR2", positionGroup: "offense", depthOrder: 1, jerseyNumber: 11, height: "6-0", weight: "200", age: 26, college: "Arizona State", experience: 5, injuryStatus: "Active", espnId: "4360438", stats: { recYds: 1050, recTD: 7, rec: 68, targets: 100 } },
  ...
  { id: pid("SF", "TE", 1), name: "George Kittle", team: "SF", position: "TE", positionGroup: "offense", depthOrder: 1, jerseyNumber: 85, height: "6-4", weight: "250", age: 31, college: "Iowa", experience: 8, injuryStatus: "Active", espnId: "3040151", stats: { recYds: 780, recTD: 6, rec: 58, targets: 78 } },
  ...
  { id: pid("SF", "LT", 1), name: "Trent Williams", team: "SF", position: "LT", positionGroup: "offense", depthOrder: 1, jerseyNumber: 71, height: "6-5", weight: "320", age: 36, college: "Oklahoma", experience: 15, injuryStatus: "Active", espnId: "14076", stats: { gamesStarted: 16, sacks: 1 } },
  ...
  // --- Defense ---
  { id: pid("SF", "DE1", 1), name: "Nick Bosa", team: "SF", position: "DE1", positionGroup: "defense", depthOrder: 1, jerseyNumber: 97, height: "6-4", weight: "266", age: 27, college: "Ohio State", experience: 6, injuryStatus: "Active", espnId: "3918003", stats: { tackles: 50, sacks: 12.5, tfl: 15, ff: 3 } },
  ...
  { id: pid("SF", "LB1", 1), name: "Fred Warner", team: "SF", position: "LB1", positionGroup: "defense", depthOrder: 1, jerseyNumber: 54, height: "6-3", weight: "230", age: 28, college: "BYU", experience: 7, injuryStatus: "Active", espnId: "3115364", stats: { tackles: 130, sacks: 4.0, tfl: 10, int: 2 } },
  ...
  { id: pid("SF", "CB1", 1), name: "Charvarius Ward", team: "SF", position: "CB1", positionGroup: "defense", depthOrder: 1, jerseyNumber: 7, height: "6-1", weight: "196", age: 28, college: "Middle Tennessee", experience: 7, injuryStatus: "Active", espnId: "3121015", stats: { tackles: 50, int: 4, pd: 15, ff: 0 } },
  ...
  // =============================================
  // --- Offense ---
  { id: pid("BUF", "QB", 1), name: "Josh Allen", team: "BUF", position: "QB", positionGroup: "offense", depthOrder: 1, jerseyNumber: 17, height: "6-5", weight: "237", age: 28, college: "Wyoming", experience: 7, injuryStatus: "Active", espnId: "3918298", stats: { passYds: 4306, passTD: 35, int: 10, qbr: 96.8 } },
  ...
  { id: pid("BUF", "RB", 1), name: "James Cook", team: "BUF", position: "RB", positionGroup: "offense", depthOrder: 1, jerseyNumber: 4, height: "5-11", weight: "199", age: 25, college: "Georgia", experience: 3, injuryStatus: "Active", espnId: "4379399", stats: { rushYds: 1122, rushTD: 9, ypc: 5.0, rec: 40 } },
  ...
  { id: pid("BUF", "WR1", 1), name: "Stefon Diggs", team: "BUF", position: "WR1", positionGroup: "offense", depthOrder: 1, jerseyNumber: 14, height: "6-0", weight: "191", age: 31, college: "Maryland", experience: 10, injuryStatus: "Active", espnId: "2976212", stats: { recYds: 1100, recTD: 8, rec: 88, targets: 130 } },
  { id: pid("BUF", "WR1", 2), name: "Khalil Shakir", team: "BUF", position: "WR1", positionGroup: "offense", depthOrder: 2, jerseyNumber: 10, height: "6-0", weight: "190", age: 25, college: "Boise State", experience: 3, injuryStatus: "Active", espnId: "4373678", stats: { recYds: 520, recTD: 4, rec: 45, targets: 60 } },
  ...
  { id: pid("BUF", "WR2", 2), name: "Khalil Shakir", team: "BUF", position: "WR2", positionGroup: "offense", depthOrder: 2, jerseyNumber: 10, height: "6-0", weight: "190", age: 25, college: "Boise State", experience: 3, injuryStatus: "Active", espnId: "4373678", stats: { recYds: 520, recTD: 4, rec: 45, targets: 60 } },
  ...
  { id: pid("BUF", "WR3", 1), name: "Khalil Shakir", team: "BUF", position: "WR3", positionGroup: "offense", depthOrder: 1, jerseyNumber: 10, height: "6-0", weight: "190", age: 25, college: "Boise State", experience: 3, injuryStatus: "Active", espnId: "4373678", stats: { recYds: 520, recTD: 4, rec: 45, targets: 60 } },
  ...
  { id: pid("BUF", "TE", 1), name: "Dalton Kincaid", team: "BUF", position: "TE", positionGroup: "offense", depthOrder: 1, jerseyNumber: 86, height: "6-4", weight: "240", age: 25, college: "Utah", experience: 2, injuryStatus: "Questionable", injuryDetail: "Knee — missed practice Thu", practiceStatus: "DNP", espnId: "4385690", stats: { recYds: 680, recTD: 4, rec: 60, targets: 80 } },
  { id: pid("BUF", "TE", 2), name: "Dawson Knox", team: "BUF", position: "TE", positionGroup: "offense", depthOrder: 2, jerseyNumber: 88, height: "6-4", weight: "254", age: 27, college: "Ole Miss", experience: 6, injuryStatus: "Active", espnId: "3930086", stats: { recYds: 280, recTD: 3, rec: 25, targets: 35 } },
  ...
  { id: pid("BUF", "KR", 1), name: "Khalil Shakir", team: "BUF", position: "KR", positionGroup: "specialTeams", depthOrder: 1, jerseyNumber: 10, height: "6-0", weight: "190", age: 25, college: "Boise State", experience: 3, injuryStatus: "Active", espnId: "4373678", stats: { krYds: 400, krAvg: 23.5, krTD: 0, krLong: 45 } },
  ...
  { id: pid("BUF", "PR", 1), name: "Khalil Shakir", team: "BUF", position: "PR", positionGroup: "specialTeams", depthOrder: 1, jerseyNumber: 10, height: "6-0", weight: "190", age: 25, college: "Boise State", experience: 3, injuryStatus: "Active", espnId: "4373678", stats: { prYds: 160, prAvg: 9.4, prTD: 0, prLong: 22 } },
  ...
  // =============================================
  // --- Offense ---
  { id: pid("MIA", "QB", 1), name: "Tua Tagovailoa", team: "MIA", position: "QB", positionGroup: "offense", depthOrder: 1, jerseyNumber: 1, height: "6-1", weight: "217", age: 26, college: "Alabama", experience: 5, injuryStatus: "Active", espnId: "4241479", stats: { passYds: 4015, passTD: 29, int: 8, qbr: 96.5 } },
  ...
  { id: pid("MIA", "RB", 1), name: "De'Von Achane", team: "MIA", position: "RB", positionGroup: "offense", depthOrder: 1, jerseyNumber: 28, height: "5-9", weight: "188", age: 23, college: "Texas A&M", experience: 2, injuryStatus: "Active", espnId: "4429160", stats: { rushYds: 980, rushTD: 10, ypc: 5.8, rec: 35 } },
  ...
  { id: pid("MIA", "WR1", 1), name: "Tyreek Hill", team: "MIA", position: "WR1", positionGroup: "offense", depthOrder: 1, jerseyNumber: 10, height: "5-10", weight: "185", age: 30, college: "West Alabama", experience: 9, injuryStatus: "Active", espnId: "3116406", stats: { recYds: 1480, recTD: 13, rec: 105, targets: 140 } },
  { id: pid("MIA", "WR1", 2), name: "Jaylen Waddle", team: "MIA", position: "WR1", positionGroup: "offense", depthOrder: 2, jerseyNumber: 17, height: "5-10", weight: "182", age: 26, college: "Alabama", experience: 4, injuryStatus: "Active", espnId: "4372016", stats: { recYds: 850, recTD: 5, rec: 62, targets: 90 } },
  ...
  { id: pid("MIA", "WR2", 1), name: "Jaylen Waddle", team: "MIA", position: "WR2", positionGroup: "offense", depthOrder: 1, jerseyNumber: 17, height: "5-10", weight: "182", age: 26, college: "Alabama", experience: 4, injuryStatus: "Active", espnId: "4372016", stats: { recYds: 850, recTD: 5, rec: 62, targets: 90 } },
  ...
  { id: pid("MIA", "KR", 2), name: "De'Von Achane", team: "MIA", position: "KR", positionGroup: "specialTeams", depthOrder: 2, jerseyNumber: 28, height: "5-9", weight: "188", age: 23, college: "Texas A&M", experience: 2, injuryStatus: "Active", espnId: "4429160", stats: { krYds: 80, krAvg: 20.0, krTD: 0, krLong: 28 } },
  ...
  { id: pid("MIA", "PR", 2), name: "Jaylen Waddle", team: "MIA", position: "PR", positionGroup: "specialTeams", depthOrder: 2, jerseyNumber: 17, height: "5-10", weight: "182", age: 26, college: "Alabama", experience: 4, injuryStatus: "Active", espnId: "4372016", stats: { prYds: 30, prAvg: 6.0, prTD: 0, prLong: 12 } },
